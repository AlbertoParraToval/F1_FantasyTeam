...
export class TeamsService {
  ...
  public teamsInfo: teamsModel[] = [
    ...
    },
    {
      ...
      puntosTemporada: "55 puntos.",
      description: "Alfa Romeo Racing es un equipo privado de origen suizo con sede en Hinwil, Suiza. Está constituido en sociedad anónima. Su accionista mayoritario es el grupo inversor Longbow Finance. Es fruto de la relación comercial entre el equipo Sauber F1 Team, que proporciona la fuerza logística, y la firma automovilística Alfa Romeo, que da nombre al binomio a través de un patrocinio. ",
    ...
    },
    {
      ...
      description: "AlphaTauri Honda es un equipo privado de origen italiano con sede en Faenza, Italia. Es propiedad de la marca de bebidas Red Bull, que en 2020 ha rebautizado su filial Toro Rosso con el nombre de una marca de ropa de la compañía.",
    ...
    },
    {
      ...
      description: "Haas F1 Team es un equipo privado de origen estadounidense con sedes en Banbury Reino Unido y Kannapolis Estados Unidos. Es propiedad de su fundador Gene Haas.",
